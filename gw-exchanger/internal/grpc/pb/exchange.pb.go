...
type ExchangeRateResponse struct {
	...
	FromCurrency string  `protobuf:"bytes,1,opt,name=from_currency,json=fromCurrency,proto3" json:"from_currency,omitempty"`
	ToCurrency   string  `protobuf:"bytes,2,opt,name=to_currency,json=toCurrency,proto3" json:"to_currency,omitempty"`
	Rate         float64 `protobuf:"fixed32,3,opt,name=rate,proto3" json:"rate,omitempty"`
}
...
type ExchangeRatesResponse struct {
	...
	Rates map[string]float64 `protobuf:"bytes,1,rep,name=rates,proto3" json:"rates,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"fixed32,2,opt,name=value,proto3"` // ключ: валюта, значение: курс
}
